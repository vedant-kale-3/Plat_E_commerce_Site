...
export const plantGuides: PlantGuide[] = [
  {
    ...
    water: 'Weekly',
    difficulty: 'Moderate',
    summary: 'Jungle natives like Monstera, Bird of Paradise, and Swiss Cheese Vine love warmth and humidity.',
    tips: [
      'Mimic the forest floor — bright but filtered light, never harsh direct sun.',
      'Keep humidity above 50% for lush, unfurling leaves.',
      'Let the top inch of soil dry between waterings to prevent root rot.',
      'Wipe leaves monthly to keep pores clear and glossy.',
    ],
  },
  {
    category: 'Succulent',
    ...
    difficulty: 'Easy',
    summary: 'Aloe, Echeveria, and Haworthia store water in their leaves and thrive on a little neglect.',
    tips: [
      'Give them the sunniest spot you have — a south-facing window is ideal.',
      'Let the soil dry out completely before watering again.',
      'Use a cactus/succulent mix with excellent drainage.',
      'Water the soil, not the rosette — trapped water causes rot.',
    ],
  },
  {
    category: 'Trailing',
    ...
    water: 'Weekly',
    difficulty: 'Easy',
    summary: 'Pothos and Philodendron trail beautifully and forgive the occasional missed watering.',
    tips: [
      'Tolerates lower light, but growth is fuller and faster in bright indirect light.',
      'Prune regularly to encourage bushy, branching vines.',
      'Propagate cuttings in water for easy new plants.',
      'Yellow leaves usually mean overwatering — let it dry out more.',
    ],
  },
  {
    category: 'Foliage',
    ...
    water: 'Every 10 days',
    difficulty: 'Easy',
    summary: 'Statement foliage plants like ZZ and Rubber Plant bring sculptural structure to any room.',
    tips: [
      'Extremely forgiving of low light and irregular watering.',
      'Dust the broad leaves regularly for a polished look.',
      'Allow the soil to dry almost completely between waterings.',
      'Fertilise monthly in spring and summer for strong new growth.',
    ],
  },
  {
    category: 'Flowering',
    ...
    water: 'Weekly',
    difficulty: 'Moderate',
    summary: 'Peace Lilies and Anthurium reward good care with elegant blooms and air-purifying foliage.',
    tips: [
      'Keep soil lightly moist but never waterlogged.',
      'Remove spent blooms to encourage new flowers.',
      'Bright indirect light promotes blooming; deep shade keeps it leafy.',
      'Slightly higher humidity helps flowers last longer.',
    ],
  },
  {
    category: 'Trees',
    ...
    water: 'Weekly',
    difficulty: 'Expert',
    summary: 'Ficus trees and braided specimens are striking floor plants that need consistent conditions.',
    tips: [
      'Hates being moved — pick a spot and keep it there to avoid leaf drop.',
      'Keep humidity moderate and away from cold draughts.',
      'Water when the top 2 inches of soil are dry.',
      'Prune in spring to control shape and encourage branching.',
    ],
  },
  {
    category: 'Hanging',
    ...
    difficulty: 'Easy',
    summary: 'Trailing peperomia and ferns cascade from baskets and shelves, softening any corner.',
    tips: [
      'Check soil moisture by lifting the pot — light pots mean it is time to water.',
      'Pinch back growing tips to keep the plant full and rounded.',
      'Keep away from drying air vents that crisp the delicate foliage.',
      'Rotate the hanger occasionally so all sides get light.',
    ],
  },
];
